...
void main() {
    ...
    (tester) async {
      ...
      final items = [
        HardwareItem(
          id: 'router',
          name: 'Router',
          imagePath: 'missing/router.png',
        ),
        HardwareItem(
          id: 'switch',
          name: 'Switch',
          imagePath: 'missing/switch.png',
        ),
        HardwareItem(
          id: 'modem',
          name: 'Modem',
          imagePath: 'missing/modem.png',
        ),
        HardwareItem(
          id: 'crimper',
          name: 'Crimping Tool',
      ...
      await tester.pump();
      expect(
        find.text('A router forwards traffic between networks.'),
        findsOneWidget,
      );
  ...
  testWidgets('installation feedback does not move the workspace', (
    ...
    final workspaceTarget = find.byKey(
      const ValueKey('drop-target-motherboard_area'),
    );
...
Future<void> _recoverTestSession() async {
  ...
  final jwtPart = base64Url.encode(
    utf8.encode(
      jsonEncode({
