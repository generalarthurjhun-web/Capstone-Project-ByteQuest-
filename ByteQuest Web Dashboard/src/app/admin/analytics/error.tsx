    ...
    <DashboardLayout>
      <div className="mx-auto flex min-h-[55vh] max-w-xl items-center justify-center">
        <div role="alert" className="w-full rounded-xl border border-destructive/25 bg-card p-7 text-center">
          ...
          <h1 className="mt-4 text-lg font-semibold">Unable to load system analytics</h1>
          <p className="mt-2 text-sm leading-6 text-muted-foreground">The read-only system aggregation did not complete. No account, assessment, or audit record was changed.</p>
