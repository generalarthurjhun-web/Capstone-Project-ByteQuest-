-- The COC2 evidence-operator extension replaced this function after the
-- earlier JSON-precedence repair. Preserve the extended set operator while
-- parenthesizing JSON extraction operands explicitly.
